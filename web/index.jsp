...
<body>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
              Started since the foundation of the Vidyapith in 1920, the Central Library has grown over the years to become one of the richest repositories of books, journals and manuscripts in Gujarat . The library remains open 364 days a year, remaining closed only on the first day of the Vikram Samvat.
            </p>
            <a href="https://gujaratvidyapith.org/centrallibrary.htm#:~:text=Started%20since%20the%20foundation%20of%20the%20Vidyapith%20in%201920%2C%20the,day%20of%20the%20Vikram%20Samvat.">
              Read More
            </a>
          </div>
        </div>
  ...
  <section class="professional_section layout_padding">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="images/professional-img.jpeg" alt="">
          </div>
        </div>
        <div class="col-md-6 ">
          <div class="detail-box">
            <h2>
              Gujarat Vidyapith is a deemed <br>
            ...
            <a href="https://en.wikipedia.org/wiki/Gujarat_Vidyapith">
              Read More
            </a>
          </div>
        </div>
  ...
  <section class="info_section ">
      ...
      <div class="row">
        <div class="col-lg-10 mx-auto">
          <div class="info_items">
            <div class="row">
              <div class="col-md-4">
                <a href="https://maps.app.goo.gl/4qU9aodurfAJmshv7">
                  <div class="item ">
                    <div class="img-box ">
    ...
    <div class="social-box">
      ...
      <div class="box">
        <a href="https://www.facebook.com/gvp1920/">
          <i class="fa fa-facebook" aria-hidden="true"></i>
        </a>
        <a href="https://x.com/gvp1920">
          <i class="fa fa-twitter" aria-hidden="true"></i>
        </a>
        <a href="https://www.youtube.com/channel/UC4p0sHYuLfKDVYQOtlq8w5g">
          <i class="fa fa-youtube" aria-hidden="true"></i>
        </a>
        <a href="https://www.instagram.com/gvp1920/">
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        ...
        <a href="https://html.design/">LMS</a>
      </p>
    </div>
  </footer>
  <!-- footer section -->
